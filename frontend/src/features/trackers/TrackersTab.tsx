...
// projection logic:
//   - High volume: favoured/neutral speed map, jockey win% (90d) >= 20
//     (with a >=25-start sample when that count is known), within 5 WPR
//     of the race's top-projected runner, $3+ price. A
